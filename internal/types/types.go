...
type ScanArgs struct {
	...
	MinSASTSeverity string   `json:"min_sast_severity,omitempty" jsonschema:"description=Minimum SAST severity to return: LOW, MEDIUM, HIGH, or CRITICAL. Default: LOW"`
}
